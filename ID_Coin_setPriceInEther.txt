...
contract ProgressiveToken is owned, token {
    uint256 public constant totalSupply=16815093750;          // the amount of total coins avilable.
   ...
   mapping  (uint256 => uint256) rewardArray;                  //create an array with all reward values.
	...
	setPrices(sellPrice,buyPrice);                   // sets sell and buy price.
        ...
        reward=12800;                                    //initialising reward with initial reward as per calculation.
   ...
   /* Calculates value of reward at given time */
    ...
    function setPrices(uint256 newSellPrice, uint256 newBuyPrice) onlyOwner {
        sellPrice = newSellPrice*(10**18);          //initialising sellPrice so that sell price becomes value of coins in Wei
        buyPrice = newBuyPrice*(10**18);            //initialising buyPrice so that buy price becomes value of coins in Wei
    }
